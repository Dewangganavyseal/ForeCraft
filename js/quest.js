...
const Quest={
  ...
  DEFS:[
    ...
    {id:'q_venom',  e:'☠️', name:'Racun untuk Bilah',    lvl:23, rar:'rare', rep:true,
     ...
     desc:'Pandai besi meracik Taring Racun — butuh racun kalajengking gurun.',
    ...
    {id:'q_frost',  e:'❄️', name:'Pedang Fajar Beku',    lvl:29, rar:'epic', rep:false,
     type:'craft',  target:'sword_frost', n:1,
     desc:'Tempa pedang legendaris berhawa beku untuk penjaga desa.',
    ...
    {id:'q_titan',  e:'🗡️', name:'Penghancur Titan',      lvl:44, rar:'epic', rep:false,
     type:'craft',  target:'sword_titan', n:1,
     desc:'Tempa pedang terkuat dari inti boss Tanah Merah.',
