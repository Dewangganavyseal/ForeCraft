...
const Quest={
  ...
  DEFS:[
    ...
    {id:'q_semut2', e:'🐜', name:'Sarang Semut Terdalam', lvl:42, rar:'epic', rep:true,
     ...
     reward:{centipede_shell:6,crystal:5}},
    ...
    {id:'q_kelabang',e:'🪱', name:'Kelabang dari Altar',  lvl:50, rar:'epic', rep:true,
     ...
     reward:{centipede_shell:8,crystal:11}},
    ...
    {id:'q_dboss1',  e:'👑', name:'Penjaga Agung Pertama',      lvl:70, rar:'epic', rep:true,
     ...
     reward:{soul_shard:6,gold_ingot:5,crystal:4}},
    {id:'q_core2',   e:'🧿', name:'Inti Boss Ganda',           lvl:80, rar:'epic', rep:true,
     ...
     reward:{crystal:10,gold_ingot:6}},
    ...
    {id:'q_soul3',   e:'🔮', name:'Pecahan Jiwa Massal',       lvl:120, rar:'epic', rep:true,
     ...
     reward:{crystal:14,gold_ingot:8}},
    {id:'q_dboss3',  e:'👑', name:'Dewa Reruntuhan',           lvl:150, rar:'epic', rep:true,
     ...
     reward:{soul_shard:10,gold_ingot:10,crystal:8}},
    {id:'q_core3',   e:'🧿', name:'Gudang Inti Boss',          lvl:180, rar:'epic', rep:true,
     ...
     reward:{crystal:20,gold_ingot:12}},
     {id:'q_dboss4',  e:'👑', name:'Puncak Reruntuhan',         lvl:200, rar:'epic', rep:true,
      ...
      reward:{soul_shard:12,gold_ingot:15,crystal:12}},
     /* ---- 7 quest tambahan (menambah variasi papan; batas ambil tetap MAX=3) ---- */
     {id:'q_rope3',   e:'➰', name:'Persediaan Tali',             lvl:6,  rar:'common', rep:true,
      type:'craft',  target:'rope', n:6,
      desc:'Pedagang butuh banyak tali untuk mengikat kargo dagangannya.',
      reward:{iron_ingot:2,bread:3}},
     {id:'q_boar2',   e:'🐗', name:'Hama Ladang',                 lvl:5,  rar:'common', rep:true,
      type:'kill',   target:'boar', n:8,
      desc:'Babi hutan merusak ladang desa. Bersihkan dari mereka.',
      reward:{bread:3,stone:6}},
     {id:'q_pelt2',   e:'🐺', name:'Musim Bulu',                 lvl:8,  rar:'common', rep:true,
      type:'gather', target:'pelt', n:8,
      desc:'Penjahit mengumpulkan bulu hangat sebelum musim dingin tiba.',
      reward:{rope:3,bread:3}},
     {id:'q_cfish2',  e:'🍢', name:'Pesta Bakar Ikan',           lvl:9,  rar:'common', rep:true,
      type:'craft',  target:'cfish', n:8,
      desc:'Perbekalan bakar untuk rombongan pedagang yang singgah.',
      reward:{bread:4,iron_ingot:2}},
     {id:'q_resin',   e:'🍯', name:'Getah Pohon Manis',          lvl:14, rar:'uncommon', rep:true,
      type:'gather', target:'resin', n:12,
      desc:'Tabib memerlukan getah sebagai bahan dasar ramuan & lilin.',
      reward:{bandage:2,gel:4}},
     {id:'q_scorp3',  e:'🦂', name:'Racun Gurun',                lvl:22, rar:'uncommon', rep:true,
      type:'kill',   target:'scorpion', n:6,
      desc:'Pandai butuh kelenjar racun kalajengking untuk melapisi bilah pedang.',
      reward:{iron_ingot:4,venom:2}},
     {id:'q_golem2',  e:'🗿', name:'Pecahan Inti Golem',         lvl:30, rar:'rare', rep:true,
      type:'kill',   target:'golem', n:4,
      desc:'Golem batu berkeliaran di tambang; hancurkan untuk mengambil intinya.',
      reward:{iron_ingot:6,gold_ingot:2,crystal:2}},
   ],
