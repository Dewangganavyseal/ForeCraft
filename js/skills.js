...
BLOCK_PROF[B.ORE_COAL]    ={sk:'mining',     xp:12, lvl:2};
...
BLOCK_PROF[B.CASTLE_WALL]={sk:'mining',     xp:14, lvl:5};
BLOCK_PROF[B.FENCE]      ={sk:'logging',    xp:6,  lvl:1};
BLOCK_PROF[B.GATE]       ={sk:'logging',    xp:8,  lvl:3};
