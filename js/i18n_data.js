...
const I18N_PHRASE={
  ...
  'Klik / tap di permukaan dunia untuk menata blok':['Click / tap the world surface to place blocks','点击世界表面以放置方块','地面をクリック/タップしてブロックを配置'],
  ...
  'Pilih blok di tab Block tas terlebih dahulu!':['Select a block in the Bag Blocks tab first!','请先在背包方块栏选择方块！','まずバッグのブロック欄でブロックを選択してください！'],
  'Tidak bisa memasang blok di sini!':['Cannot place block here!','无法在此放置方块！','ここにブロックを配置できません！'],
  'Belum ada blok di tas! Hancurkan/tambang blok di dunia terlebih dahulu.':['No blocks in bag! Mine or break blocks in the world first.','背包中没有方块！请先在世界中采集方块。','バッグにブロックがありません！まず世界でブロックを採掘してください。'],
  'Terlalu jauh! Mendekatlah.':['Too far! Move closer.','太远了！请靠近一些。','遠すぎます！もっと近づいてください。'],
  'Belum ada blok di tas! Kumpulkan blok dari biome terlebih dahulu.':['No blocks in bag! Gather blocks from biomes first.','背包中没有方块！请先从生物群系采集方块。','バッグにブロックがありません！まずバイオームからブロックを採掘してください。'],
  'Tidak ada posisi yang valid atau blok di tas tidak cukup!':['No valid position or not enough blocks in bag!','没有有效位置或背包方块不足！','有効な配置位置がないか、ブロックが不足しています！'],
  'Berhasil memasang':['Successfully placed','成功放置','配置に成功しました'],
