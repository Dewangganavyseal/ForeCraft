...
/* =============================================================================
   ...
   -----------------------------------------------------------------------------
   File mandiri: MODEL 3D (build) + ANIMASI (animate). Warrior adalah
   petarung garis depan, memegang pedang. Badan jubah & animasi sama persis dengan
...
const NPC_Warrior={
  ...
  build(){
    ...
    const ROBE=0x8f3b3b,HOOD=0x5a2323,
    ...
    /* --- ALAT / SENJATA PERAN --- */
               /* pedang: gagang, guard, bilah */
    grip.add(at(box(0.06,0.05,0.06,0x2f2413),0,0.10,0));
    grip.add(at(box(0.05,0.16,0.05,WOODC),0,0.02,0));
    grip.add(at(box(0.058,0.03,0.058,0x2f2413),0,0.06,0));
    grip.add(at(box(0.26,0.05,0.08,GOLD),0,-0.07,0));
    grip.add(at(box(0.08,0.07,0.09,GOLD),0,-0.07,0));
    const blade=new THREE.Group();blade.position.set(0,-0.10,0);
    blade.add(at(box(0.10,0.10,0.04,METAL_D),0,0,0));
    blade.add(at(box(0.09,0.56,0.035,METAL),0,-0.34,0));
    blade.add(at(box(0.03,0.50,0.04,METAL_D),0,-0.34,0));
    blade.add(at(box(0.012,0.54,0.015,METAL_H),0.048,-0.34,0));
    blade.add(at(box(0.012,0.54,0.015,METAL_H),-0.048,-0.34,0));
    blade.add(at(box(0.07,0.06,0.03,METAL_H),0,-0.64,0));
    blade.add(at(box(0.04,0.05,0.025,0xffffff),0,-0.69,0));
    grip.add(blade);
    ROT(grip,-0.15,0,-0.08);
