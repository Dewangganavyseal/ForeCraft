...
/* =============================================================================
   ...
   -----------------------------------------------------------------------------
   File mandiri: MODEL 3D (build) + ANIMASI (animate). Miner adalah
   penambang yang cepat menggali, memegang beliung. Badan jubah & animasi sama persis dengan
...
const NPC_Miner={
  ...
  build(){
    ...
    const ROBE=0x6b5a3a,HOOD=0x4a3c26,
    ...
    /* --- ALAT / SENJATA PERAN --- */
                       /* beliung: gagang + kepala */
    grip.add(at(box(0.055,0.80,0.055,WOODC),0,-0.30,0));
    grip.add(at(box(0.065,0.10,0.065,WOOD_D),0,0.06,0));
    const phead=new THREE.Group();phead.position.set(0,-0.72,0);
    phead.add(at(box(0.36,0.07,0.07,METAL),0,0,0));
    phead.add(at(box(0.10,0.09,0.09,METAL_D),0,0,0));
    phead.add(at(box(0.07,0.14,0.07,METAL),0.19,-0.03,0));
    phead.add(at(box(0.07,0.14,0.07,METAL),-0.19,-0.03,0));
    phead.add(at(box(0.05,0.05,0.05,METAL_H),0.21,-0.10,0));
    phead.add(at(box(0.05,0.05,0.05,METAL_H),-0.21,-0.10,0));
    grip.add(phead);
    ROT(grip,0.28,0,0.10);
