...
/* =============================================================================
   ...
   -----------------------------------------------------------------------------
   File mandiri: MODEL 3D (build) + ANIMASI (animate). Guard adalah
   penjaga yang berpatroli melindungi desa, memegang garu desa. Badan jubah & animasi sama persis dengan
...
const NPC_Guard={
  ...
  build(){
    ...
    const ROBE=0xa8552f,HOOD=0x3c4a68,
